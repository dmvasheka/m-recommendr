  ...
  return (
    <div className="group relative">
      <Link href={`/tv-shows/${tvShow.id}`}>
        <div className="overflow-hidden rounded-xl border border-white/5 bg-[#1a1a2e]/40 backdrop-blur-sm transition-all duration-300 hover:scale-[1.02] hover:border-[#3b82f6]/30 hover:shadow-[0_0_30px_rgba(59,130,246,0.15)]">
